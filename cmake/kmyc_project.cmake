...
macro(kmyc_project_setup app_id)
    ...
    list(APPEND EXTRA_COMPONENT_DIRS "${KMYC_ROOT}/components/kmyc_platform")
    if(KMYC_BRIDGE_ENABLED STREQUAL "1")
        list(APPEND EXTRA_COMPONENT_DIRS "${KMYC_ROOT}/components/kmyc_controller")
    endif()
